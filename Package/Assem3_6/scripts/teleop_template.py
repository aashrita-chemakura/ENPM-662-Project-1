...
if __name__=="__main__":
    ...
    try:
        ...
        while(1):
            ...
            pub_right_turn.publish(control_turn)
            pub_left_turn.publish(control_turn)
            pub_right_back.publish(control_speed)
            pub_left_back.publish(control_speed) # publish the control speed. 
        ...
        pub_left_turn.publish(control_turn)
        pub_right_back.publish(control_speed)
        pub_left_back.publish(control_speed)
